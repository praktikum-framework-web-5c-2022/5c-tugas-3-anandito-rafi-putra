               ...
               @endif 
                <form action="{{ route('dosen.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" name="nidn" placeholder="masukkan nidn" id="nidn"  value="{{ old('nidn') }}"
                        class="form-control">
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="tempat_lahir" placeholder="masukkan tempat lahir"   id="tempat_lahir"   value="{{ old('tempat_lahir') }}"  class="form-control">
                ...
                <div class="form-floating mb-3">
                    <input type="date" name="tanggal_lahir" placeholder="masukkan tanggal lahir" id="tanggal"  value="{{ old('tanggal_lahir')}}" class="form-control">
