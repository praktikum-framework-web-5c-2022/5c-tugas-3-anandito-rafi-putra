...
<div class="container mt-3">
    <div class="header">
        ...
        <p>Halaman ini menampilkan data <span style="color: pink">Dosen</span></p>
            <a href="{{ route('dosen.create') }}" class="btn" style="background-color: #800000; color: white">Tambah</a>
        </div>
    <br>
                ...
                @forelse ($dosens as $dosen)
                    <tr>
                        ...
                        <td>
                           ...
                           <br>
                            <a href="{{ route('dosen.destroy',['dosen' => $dosen->id]) }}" class="btn btn-danger mt-2" >Delete</a>
                        </td>
                    </tr>
                @empty
