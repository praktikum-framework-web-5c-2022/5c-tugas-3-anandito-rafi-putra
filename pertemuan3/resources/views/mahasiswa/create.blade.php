               ...
               @endif 
                <form action="{{ route('mahasiswa.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" name="npm" placeholder="masukkan npm" id="npm"  value="{{ old('npm')}}"
                        class="form-control">
                ...
                <div class="form-floating mb-3">
                    <input type="date" name="tanggal_lahir" placeholder="masukkan tanggal lahir" id="tanggal"
